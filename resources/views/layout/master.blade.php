...
<head>
  ...
  <!-- Favicons -->
  <link href="{{asset('img/apple-touch-icon.jpg')}}" rel="icon" class="logolink">
  ...
  <link href="{{ asset('vendor/bootstrapp/css/bootstrap.min.css')}}" rel="stylesheet">
  <link href="{{asset('vendor/bootstrapicons/bootstrap-icons.css')}}" rel="stylesheet">
...
<body>
  ...
  <div id="topbar" class="d-flex align-items-center fixed-top">
    <div class="container d-flex justify-content-center justify-content-md-between">
      ...
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-phone d-flex align-items-center"><span>+216 26 610 101</span></i>
  ...
  <header id="header" class="fixed-top d-flex align-items-cente">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <img class="profilelogo" src="{{asset('img/apple-touch-icon.jpg')}}"  rel="icon" height="50px" width="50px"> <h1 class="logo me-auto me-lg-0"><a href="localhost:8000">La Famiglia</a></h1>
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
        <div class="col-lg-8">
          <h1>Welcome to <span>La Famiglia</span></h1>
        ...
        <div class="col-lg-4 d-flex align-items-center justify-content-center position-relative" data-aos="zoom-in" data-aos-delay="200">
          <a href="https://www.facebook.com/plugins/post.php?href=https%3A%2F%2Fwww.facebook.com%2FLaFamiglia110%2Fposts%2F111041334658909&show_text=true&width=500" width="200" height="300" style="border:none;overflow:hidden" class="glightbox play-btn"></a>
        </div>
        ...
        <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-6 menu-item filter-starters">
            ...
            <div class="menu-content">
              <a href="#">Lobster Bisque</a><span>5.95DT</span>
            </div>
          ...
          <div class="col-lg-6 menu-item filter-specialty">
            ...
            <div class="menu-content">
              <a href="#">Bread Barrel</a><span>6.95DT</span>
            </div>
            <div class="menu-ingredients">
              Lorem, deren, trataro, filede, nerada
            </div>
          ...
          <div class="col-lg-6 menu-item filter-starters">
            ...
            <div class="menu-content">
              <a href="#">Crab Cake</a><span>7.95DT</span>
            </div>
            <div class="menu-ingredients">
          ...
          <div class="col-lg-6 menu-item filter-salads">
            ...
            <div class="menu-content">
              <a href="#">Caesar Selections</a><span>8.95DT</span>
            </div>
            <div class="menu-ingredients">
              Lorem, deren, trataro, filede, nerada
            </div>
          ...
          <div class="col-lg-6 menu-item filter-specialty">
            ...
            <div class="menu-content">
              <a href="#">Tuscan Grilled</a><span>9.95DT</span>
            </div>
            <div class="menu-ingredients">
          ...
          <div class="col-lg-6 menu-item filter-starters">
            ...
            <div class="menu-content">
              <a href="#">Mozzarella Stick</a><span>4.95DT</span>
            </div>
            <div class="menu-ingredients">
              Lorem, deren, trataro, filede, nerada
            </div>
          ...
          <div class="col-lg-6 menu-item filter-salads">
            ...
            <div class="menu-content">
              <a href="#">Greek Salad</a><span>9.95DT</span>
            </div>
            <div class="menu-ingredients">
          ...
          <div class="col-lg-6 menu-item filter-salads">
            ...
            <div class="menu-content">
              <a href="#">Spinach Salad</a><span>9.95DT</span>
            </div>
            <div class="menu-ingredients">
          ...
          <div class="col-lg-6 menu-item filter-specialty">
            ...
            <div class="menu-content">
              <a href="#">Lobster Roll</a><span>12.95DT</span>
            </div>
            <div class="menu-ingredients">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <form action="/booking" method="post" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
          @csrf
            ...
            <div class="col-lg-4 col-md-6 form-group mt-3 mt-md-0">
              <input type="number" class="form-control" name="phone"  id="phone" placeholder="Your Phone" data-rule="minlen:4" data-msg="Please enter at least 8 chars" >
              <div class="validate"></div>
            </div>
            ...
            <div class="member" data-aos="zoom-in" data-aos-delay="100">
              ...
              <div class="member-info">
                ...
                <div class="social">
                  ...
                  <a href="https://www.facebook.com/profile.php?id=100009747648343"><i class="bi bi-facebook"></i></a>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="member" data-aos="zoom-in" data-aos-delay="200">
              ...
              <div class="member-info">
                ...
                <div class="social">
                  <a href=""><i class="bi bi-twitter"></i></a>
                  <a href="https://www.facebook.com/mahdi.kali.9/photos_by"><i class="bi bi-facebook"></i></a>
                  <a href=""><i class="bi bi-instagram"></i></a>
                  <a href=""><i class="bi bi-linkedin"></i></a>
                </div>
              </div>
    ...
    <section id="contact" class="contact">
      ...
      <div class="container" data-aos="fade-up">
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>60 Street of Republic, Megrine 2033</p>
              </div>
        ...
        <div data-aos="fade-up">
            <div class="mapouter"><div class="gmap_canvas"><iframe width="1300" height="500" id="gmap_canvas" src="https://maps.google.com/maps?q=restauent%20la%20famiglia%20megrine&t=&z=17&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://yt2.org">yt2</a><br><style>.mapouter{padding-left: 128px;position:relative;text-align:right;height:500px;width:1200px;}</style><a href="https://www.embedgooglemap.net">embedgooglemap.net</a><style>.gmap_canvas {overflow:hidden;background:none!important;height:500px;width:1080px;}</style></div></div>
        </div>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-info">
              <h3>La Famiglia</h3>
              <p>
                60 Street of Republic, Megrine 2033<br><br>
                <strong>Phone:</strong> +216 26 610 101<br>
                <strong>Email:</strong> La-Famiglia@example.com<br>
              </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>La Famiglia</span></strong>. All Rights Reserved
      </div>
      <!-- <div class="credits">
  ...
  <script src="{{asset('vendor/bootstrapp/js/bootstrap.bundle.min.js')}}"></script>
